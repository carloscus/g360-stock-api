...
const C = JSON.parse(
  '{"s1":{"title":"G360 Stock API","subtitle":"Manual de acceso para el equipo · v1.5.0","url":"GET /api/v1/stock","key":"x-api-key: <clave>","notes":"La tapa presenta el manual y su versión. El equipo sale de esta nota sabiendo que cada consulta es una URL + un header, y que todo lo demás son ejemplos de esa llamada."}' +
  ...
  ',"s15":{"title":"Listo para consultar","subtitle":"Swagger /docs · Repositorio github.com/carloscus/g360-stock-api · v1.5.0","url":"GET /api/v1/stock","key":"elsewhere: consultar /docs","notes":"El manual termina con las tres rutas útiles: la documentación interactiva, el repositorio del servicio y la versión vigente (1.5.0)."}}'
);
